...
from wulpus.uss_conf import WulpusUssConfig, configuration_package
...
class WulpusUssConfigGUI(widgets.VBox, WulpusUssConfig):
    ...
    def init_inputs(self):
        ...
        entries_acq.append(
            self.get_param("num_samples").get_as_widget(self.num_samples)
        )
        ...
        entries_adv.append(
            self.get_param("restart_capt").get_as_widget(self.restart_capt)
        )
        entries_adv.append(
            self.get_param("capt_timeout").get_as_widget(self.capt_timeout)
        )
