...
- `sim`, containing the LTSpice simulation files for WULPUS PRO analog fron end
...
In a nutshell, to build your own instance of WULPUS PRO, the following steps should be completed:
...
3. *Flashing nRF52 DK and USB dongle firmware*<br>
...
Starting a measurement with WULPUS Pro can be accomplished in three simple steps:
- Power up the probe, either from the connector or via debug pinheaders
...
- [Cédric Hirschi](https://www.linkedin.com/in/c%C3%A9dric-cyril-hirschi-09624021b/) (?)
